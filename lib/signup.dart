                      ...
                      child: Column(
                        children: [
                          ...
                          Row(children: [
                            ...
                            TypewriterAnimatedTextKit(text:["FARMER'S APP"], textStyle:TextStyle(
                              fontSize: 50.0,
                              fontFamily: "Agne",
                              color: Colors.indigo,
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  child: RotateAnimatedTextKit(
                                    text: ["SOW", "SELL", "EARN"],
                                    textStyle: TextStyle(fontSize: 28.0, fontFamily: "Horizon", color: Colors.indigo, fontWeight: FontWeight.bold,),
...
//                                     height:10
//                                 ),
//                                 Center(child: Text('Have an Existing Account ?')),
//                                 FlatButton(
//                                   child: Text('Login',style: TextStyle(
//                                     color: Colors.white,
//                                   ),),
